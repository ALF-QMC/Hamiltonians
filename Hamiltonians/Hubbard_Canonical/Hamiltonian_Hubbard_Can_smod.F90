...
!--------------------------------------------------------------------
    ...
    submodule (Hamiltonian_main) ham_Hubbard_Can_smod
      ...
      type, extends(ham_base) :: ham_Hubbard_Can
      contains
    ...
    contains
      ...
      module Subroutine Ham_Alloc_hubbard_Can
        allocate(ham_Hubbard_Can::ham)
      end Subroutine Ham_Alloc_hubbard_Can
...
#include "Hamiltonian_Hubbard_Can_read_write_parameters.F90"
...
!--------------------------------------------------------------------
      Subroutine Ham_Set
          ...
          ! From dynamically generated file "Hamiltonian_Hubbard_Can_read_write_parameters.F90"
...
!-------------------------------------------------------------------
    ...
    end submodule ham_Hubbard_Can_smod
