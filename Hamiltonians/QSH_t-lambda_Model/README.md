...
Physically, the implementation supports the honeycomb lattice. Note that the spin is encoded as layer such that in the parameter file `Lattice_type = "Bilayer_honeycomb"` has to be chosen.    The parameter file  for  this
